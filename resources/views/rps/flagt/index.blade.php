			    ...
			    <div class="modal-body">
				    	...
				    	<div class="row">
				    		<div class="col-md-12">
				    			<div class="form-group">
				    				{!! Form::label('','Map file(image)') !!}
				    				<a target="_blank" href="<?php echo asset('/public/storage/'.$flagts->map_filepath) ?>"><img src="<?php echo asset('/public/storage/'.$flagts->map_filepath) ?>" alt="picture"></a>
				    			</div>
				    		</div>
				    	</div>
				    	<div class="row">
				    		<div class="col-md-12">
				    			<div class="form-group">
				    				{!! Form::label('','Approved Documents file') !!}
				    				<a target="_blank" href="<?php echo asset('/public/storage/'.$flagts->approveddocs_filepath) ?>"><img src="<?php echo asset('/public/storage/'.$flagts->approveddocs_filepath) ?>" alt="picture"></a>
				    			</div>
				    		</div>
				    	</div>
				    	<div class="row">
